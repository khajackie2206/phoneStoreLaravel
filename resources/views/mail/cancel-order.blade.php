                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        <h1
                                            ...
                                            Đơn hàng của bạn đã bị hủy</h1>
                                        <span
                                            style="display:inline-block; vertical-align:middle; margin:29px 0 26px; border-bottom:1px solid #cecece; width:100px;"></span>
                                        <p style="color:#455056; font-size:15px;line-height:24px; margin:0;">
                                            Vì một số lý do ngoài ý muốn, đơn hàng <span style="font-weight: bold;">#{{ $order->id}}</span> của khách hàng <span style="font-weight: bold;">{{ $user->name}}</span> đã bị hủy, kính mong quý khách thông cảm và tiếp tục ủng hộ cửa hàng
                                        </p>
