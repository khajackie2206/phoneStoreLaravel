             ...
             <form action="/admin/banner/edit/{{ $banner->id }}" method="POST">
                 <div class="row">
                     ...
                     <div class="col-12 col-lg-6">
                         ...
                         <div class="card">
                             ...
                             <div class="card-body">
                                 <select class="form-select mb-1" name="type_banner">
                                     <option value="header" {{ $banner->type_banner == "header" ? 'selected' : '' }}>Tiêu đề</option>
                                     <option value="header static" {{ $banner->type_banner == "header static" ? 'selected' : '' }}>Tiêu đề tĩnh</option>
                                     <option value="center static" {{ $banner->type_banner == "center static" ? 'selected' : '' }}>Giữa Tĩnh</option>
                                     <option value="broadcast"  {{ $banner->type_banner == "broadcast" ? 'selected' : '' }}>Quảng bá</option>
                                 </select>
                             </div>
                         ...
                         <div class="card" style="padding-bottom: 58px;">
                             <div class="card-header">
