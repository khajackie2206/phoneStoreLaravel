...
<main class="content">
    <div class="container-fluid p-0">
        <div class="mb-3">
            <h1 class="h3 d-inline align-middle">Cập nhật thông tin nhà cung cấp</h1>
        </div>
        <form action="/admin/suppliers/edit/{{$supplier->id}}" method="POST">
            <div class="row">
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body" style="margin-top: -22px;">
                            <input type="text" value="{{ $supplier->name}}" class="form-control" placeholder="Tên nhà cung cấp..." name="name">
                        </div>
                        ...
                        <div class="card-body" style="margin-top: -22px;">
                            <input type="text" value="{{ $supplier->email}}" class="form-control" placeholder="Nhập email..." name="email">
                        </div>
                        <div style="height:20px;">
                        ...
                        <div class="card-body" style="margin-top: -22px;">
                            <input type="text" value="{{ $supplier->phone}}" class="form-control" placeholder="số điện thoại..." name="phone">
                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body" style="margin-top: -22px;">
                            <input type="text" value="{{ $supplier->address}}" class="form-control" placeholder="Địa chỉ nhà cung cấp..."
                                name="address">
                        </div>
                        <div style="height:20px;">
