<nav id="sidebar" class="sidebar js-sidebar">
  ...
  <span class="align-middle">Admin Dashboard</span>
      ...
      <i class="align-middle" data-feather="book-open"></i> <span class="align-middle">Bài viết</span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="pages-sign-up.html">
    <i class="align-middle" data-feather="gift"></i> <span class="align-middle">Khuyến mãi & thuế</span>
  </a>
          </li>
      ...
      <i class="align-middle" data-feather="message-circle"></i> <span class="align-middle">Phản hồi & đánh giá</span>
    </a>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link" href="ui-cards.html">
      <i class="align-middle" data-feather="dollar-sign"></i> <span class="align-middle">Doanh thu & lợi nhận</span>
    </a>
            </li>
