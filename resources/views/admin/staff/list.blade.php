                    ...
                    <div class="card-body h-100">
                        <div class="container ">
                            <div class="table-responsive">
                                <table class="table table-responsive table-borderless table-striped" id="staff-table"
                                    ...
                                    {{-- <tbody>
                                        ...
                                        <tr style="text-align: center;">
                                            ...
                                            <td><img src="{{ $user->avatar }}" width="40" style="border-radius: 50%;">
                                            </td>
                                            ...
                                            <td class="text-end">
                                                @if ($user->active == 0)
                                                <form method="post"
                                                    style=" display:inline!important; margin-right: 20px;"
                                                    action="/admin/users/change-active/{{ $user->id }}?active=1">
                                                    @csrf
                                                    <input name="_method" type="hidden" value="POST">
                                                    <i class="fa fa-unlock fa-xl show-alert-active-box"
                                                        style="color: blue;cursor: pointer;" aria-hidden="true"></i>
                                                </form>
                                                @else
                                                ...
                                                <form method="post"
                                                    ...
                                                    @csrf
                                                    <input name="_method" type="hidden" value="POST">
                                                    <i class="fa fa-lock fa-xl show-alert-delete-box "
...
<script>
    function deleteStaff(ev) {
             var urlToRedirect = ev.currentTarget.getAttribute('href');
             event.preventDefault();
             swal({
                 title: "Bạn có chắc muốn xóa tài khoản này không?",
                 icon: "warning",
                 type: "warning",
                 buttons: ["Cancel", "Yes!"],
                 confirmButtonColor: '#3085d6',
