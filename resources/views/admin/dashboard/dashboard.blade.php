                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col mt-0">
                                            <h5 class="card-title">Giao hàng</h5>
                                        </div>
                                    ...
                                    <div class="mb-0">
                                        ...
                                        <span class="text-muted">So với tuần trước</span>
                                    </div>
                                </div>
                            </div>
                            <div class="card">
                        ...
                        <div class="col-sm-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3">13.500.000 đ</h1>
                                    <div class="mb-0">
                    ...
                    <table class="table table-hover my-0">
                        <thead>
                            <tr>
                                ...
                                <th class="d-none d-xl-table-cell">Ngày giao hàng</th>
