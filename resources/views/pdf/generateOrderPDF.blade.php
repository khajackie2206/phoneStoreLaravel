...
<body>
    ...
    <div class="logo-container">
        ...
        <div style="text-align: center; margin-top: -20px;font-size:9pt; "><span style="text-decoration: underline;"> Vui lòng kiểm tra thông tin các đơn hàng</span>
        </div>
    </div>
    ...
    <table class="invoice-info-container" style="font-size: 12px;margin-bottom: 30px;">
        <tr >
            <td >
                Người xuất danh sách: <strong>{{ $user->name }}</strong>
            </td>
            <td>
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover text-nowrap" border="1" style="font-size: 9pt;text-align:center;">
            <thead>
                <tr>
                    <th style="padding: 5px 10px 5px 10px;">ID</th>
                    <th style="width: 100px; padding: 5px 10px 5px 10px;">Khách hàng</th>
                    <th style="width: 100px;">Tổng hóa đơn</th>
                    <th style="width: 100px;">Ngày đặt</th>
                    <th style="padding: 5px 10px 5px 10px;">Địa chỉ giao hàng</th>
            ...
            <tbody style="font-size: 8pt;">
                ...
                <tr >
                    ...
                    <td><span class="tag tag-success">{{ $order->order_date}}</span></td>
                    <td>{{ $order->delivery_address}}</td>
                    <td style="padding-right: 25px;">{{ $order->status->name}}</td>
                </tr>
                @endforeach
            </tbody>
        </table>
